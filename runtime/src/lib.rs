...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("pixel-chain-node"),
	impl_name: create_runtime_str!("pixel-chain-node"),
	authoring_version: 3,
	spec_version: 4,
	impl_version: 4,
...
/// Used for the module template in `./template.rs`
impl pixel_chain::Trait for Runtime {
	type Event = Event;
}
...
construct_runtime!(
		...
		UncheckedExtrinsic = UncheckedExtrinsic
	{
		...
		Sudo: sudo,
		// Used for the module template in `./template.rs`
		PixelModule: pixel_chain::{Module, Call, Storage, Event<T>},
	}
);
